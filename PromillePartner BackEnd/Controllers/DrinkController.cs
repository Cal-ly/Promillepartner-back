...
namespace PromillePartner_BackEnd.Controllers
{
    ...
    public class DrinkController : Controller
    {
        ...
        public ActionResult<IEnumerable<Drink>> Index()
        {
            ...
            drinklist.Add(new Drink(3, "Beer", 0.33, 5.0, "Beer"));                      // 13.01 grams
            drinklist.Add(new Drink(24, "Prosecco", 0.125, 11.0, "Wine"));               // 10.84 grams
            drinklist.Add(new Drink(5, "White Wine", 0.15, 12.0, "Wine"));               // 14.19 grams
            drinklist.Add(new Drink(2, "Red Wine", 0.15, 13.5, "Wine"));                 // 15.98 grams
            ...
            drinklist.Add(new Drink(25, "Jagerbomb", 0.2, 15.0, "Cocktail"));            // 23.67 grams
            ...
            drinklist.Add(new Drink(9, "Rum Shot", 0.03, 37.5, "Strong"));               // 8.86 grams
